...
export default function Login({navigation}) {
  ...
  const hided=()=>{
    ...
    const handleSignUp = () => {
      navigation.navigate("SignInBarber"); 
    };
    const resetPassword = () => {
  ...
  <View style={styles.iconlyLightOutlineArrowLeft}>
    <Svg style={styles.group} width="20" height="17" viewBox="0 0 20 17" fill="none">
      ...
      <Path d="M8.63496 14.7284C8.97741 15.0694 8.9786 15.6234 8.63763 15.9658C8.32765 16.2771 7.84161 16.3064 7.49851 16.053L7.40019 15.9685L0.34186 8.94048C0.0296164 8.62958 0.00121212 8.14178 0.256659 7.79869L0.341808 7.70043L7.40014 0.671262C7.74256 0.330261 8.29658 0.331408 8.63758 0.673824C8.94758 0.985111 8.97481 1.47128 8.71994 1.81330L8.63501 1.91126L2.19964 8.32078L8.63496 14.7284Z" fill="white" />
    </Svg>
  </View>
</TouchableOpacity>
          					</View>
...
<Path d="M12.5 0.25C5.8724 0.25 0.5 5.6224 0.5 12.25C0.5 18.8776 5.8724 24.25 12.5 24.25C19.1276 24.25 24.5 18.8776 24.5 12.25C24.5 5.6224 19.1276 0.25 12.5 0.25Z" fill="url(#paint0_linear_1228_5967)"/>
<Defs>
<LinearGradient id="paint0_linear_1228_5967" x1="4.0958" y1="3.8458" x2="22.469" y2="22.219" gradientUnits="userSpaceOnUse">
